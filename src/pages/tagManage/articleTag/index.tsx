...
import { getArticleTagList, deleteArticleTag } from '@/api/articleTag';
import { IListPageRef } from '@/interface/IListPageRef';
import ArticleTagDrawer, { IdrawerType } from './components/ArticleTagDrawer';
...
const UserTag = (props: any) => {
  ...
  const handleDelete = async (record: any) => {
    await deleteArticleTag(record.id);
